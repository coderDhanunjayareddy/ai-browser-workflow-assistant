...
def main():
    ...
    print("Calling Gemini model gemini-1.5-flash...")
    try:
        ...
        # Save response info safely to a file
        output_data = {
            "text": response.text,
            "candidates": []
        }
                    ...
                    "safety_ratings": [
                        {
                            ...
                            "blocked": r.blocked if hasattr(r, 'blocked') else None
                        } for r in (candidate.safety_ratings or [])
                    ]
                })
        
        with open("scratch/gemini_response_details.json", "w", encoding="utf-8") as f:
            json.dump(output_data, f, indent=2, ensure_ascii=False)
            
        print("Success! Details written to scratch/gemini_response_details.json")
