...
def main():
    ...
    print("Calling Gemini model gemini-2.5-flash in TEXT mode...")
    try:
        ...
        with open("scratch/gemini_raw_text_response.json", "w", encoding="utf-8") as f:
            json.dump(output_data, f, indent=2, ensure_ascii=False)
            
        print("Success! Details written to scratch/gemini_raw_text_response.json")
