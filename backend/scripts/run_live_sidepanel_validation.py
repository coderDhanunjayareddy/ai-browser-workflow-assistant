            ...
            """async () => {
                ...
                const executions = Object.values(
                    ...
                    result: record.result ? {
                        ...
                        submission_operation: record.result.submission_operation,
                        submission_attempted: record.result.submission_attempted,
                        submission_duplicate_prevented: record.result.submission_duplicate_prevented,
                        delivery_verified: record.result.delivery_verified,
                        delivered_content_identity: record.result.delivered_content_identity,
                        delivered_destination_entity: record.result.delivered_destination_entity,
                        dispatch_uncertain: record.result.dispatch_uncertain,
