...
- Complete the remaining capability matrix for frames, tab lifecycle, verified download, and production-owned content insertion. The neutral native text/select/date form, pagination, and delayed incremental-collection slices now pass.
