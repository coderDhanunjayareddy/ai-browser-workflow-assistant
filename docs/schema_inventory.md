...
- Alembic current: `20260908_0004`
- Alembic head: `20260908_0004`
- Compatible: `True`
...
| benchmark_execution_traces.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| benchmark_failures.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| benchmark_metrics.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| benchmark_reports.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| benchmark_runs.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| cognitive_checkpoints.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| cognitive_decision_comparisons.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| cognitive_evidence.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| cognitive_metrics.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| cognitive_missions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| cognitive_missions.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| cognitive_sessions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| cognitive_sessions.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| failure_records.timestamp | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_blueprint_dependencies.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_blueprint_expansions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_blueprint_nodes.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_blueprint_readiness_snapshots.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_blueprint_revisions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_blueprints.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_blueprints.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_intents.completed_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| mission_intents.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| mission_intents.dispatch_target | MATCH | INFO | varchar | varchar | Column type matches |
| mission_intents.dispatched_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_intents.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_result_artifacts.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_result_versions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_results.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_results.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| mission_tasks.attached_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| missions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| missions.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| policy_audit_events | MATCH | INFO |  |  | Table exists |
| policy_audit_events.action_id | MATCH | INFO | varchar | varchar | Column type matches |
| policy_audit_events.created_at | MATCH | INFO | timestamp with time zone | timestamp with time zone | Column type matches |
| policy_audit_events.decision_id | MATCH | INFO | varchar | varchar | Column type matches |
| policy_audit_events.event_id | MATCH | INFO | varchar | varchar | Column type matches |
| policy_audit_events.event_type | MATCH | INFO | varchar | varchar | Column type matches |
| policy_audit_events.metadata_json | MATCH | INFO | json | json | Column type matches |
| policy_audit_events.origin | MATCH | INFO | text | text | Column type matches |
| policy_audit_events.policy_decision | MATCH | INFO | varchar | varchar | Column type matches |
| policy_audit_events.reason | MATCH | INFO | text | text | Column type matches |
| policy_audit_events.session_id | MATCH | INFO | varchar | varchar | Column type matches |
| policy_audit_events.ix_policy_audit_events_action_id | MATCH | INFO |  |  | Index presence comparison |
| policy_audit_events.ix_policy_audit_events_created_at | MATCH | INFO |  |  | Index presence comparison |
| policy_audit_events.ix_policy_audit_events_decision_id | MATCH | INFO |  |  | Index presence comparison |
| policy_audit_events.ix_policy_audit_events_event_type | MATCH | INFO |  |  | Index presence comparison |
| policy_audit_events.ix_policy_audit_events_session_id | MATCH | INFO |  |  | Index presence comparison |
| policy_confirmation_receipts | MATCH | INFO |  |  | Table exists |
| policy_confirmation_receipts.action_digest | MATCH | INFO | varchar | varchar | Column type matches |
| policy_confirmation_receipts.action_id | MATCH | INFO | varchar | varchar | Column type matches |
| policy_confirmation_receipts.consumed_at | MATCH | INFO | timestamp with time zone | timestamp with time zone | Column type matches |
| policy_confirmation_receipts.created_at | MATCH | INFO | timestamp with time zone | timestamp with time zone | Column type matches |
| policy_confirmation_receipts.expires_at | MATCH | INFO | timestamp with time zone | timestamp with time zone | Column type matches |
| policy_confirmation_receipts.issued_by | MATCH | INFO | varchar | varchar | Column type matches |
| policy_confirmation_receipts.origin | MATCH | INFO | text | text | Column type matches |
| policy_confirmation_receipts.receipt_id | MATCH | INFO | varchar | varchar | Column type matches |
| policy_confirmation_receipts.session_id | MATCH | INFO | varchar | varchar | Column type matches |
| policy_confirmation_receipts.ix_policy_confirmation_receipts_action_digest | MATCH | INFO |  |  | Index presence comparison |
| policy_confirmation_receipts.ix_policy_confirmation_receipts_action_id | MATCH | INFO |  |  | Index presence comparison |
| policy_confirmation_receipts.ix_policy_confirmation_receipts_expires_at | MATCH | INFO |  |  | Index presence comparison |
| policy_confirmation_receipts.ix_policy_confirmation_receipts_session_id | MATCH | INFO |  |  | Index presence comparison |
| policy_origin_grants | MATCH | INFO |  |  | Table exists |
| policy_origin_grants.action_types | MATCH | INFO | json | json | Column type matches |
| policy_origin_grants.created_at | MATCH | INFO | timestamp with time zone | timestamp with time zone | Column type matches |
| policy_origin_grants.expires_at | MATCH | INFO | timestamp with time zone | timestamp with time zone | Column type matches |
| policy_origin_grants.grant_id | MATCH | INFO | varchar | varchar | Column type matches |
| policy_origin_grants.issued_by | MATCH | INFO | varchar | varchar | Column type matches |
| policy_origin_grants.origin | MATCH | INFO | text | text | Column type matches |
| policy_origin_grants.revoked_at | MATCH | INFO | timestamp with time zone | timestamp with time zone | Column type matches |
| policy_origin_grants.session_id | MATCH | INFO | varchar | varchar | Column type matches |
| policy_origin_grants.ix_policy_origin_grants_expires_at | MATCH | INFO |  |  | Index presence comparison |
| policy_origin_grants.ix_policy_origin_grants_origin | MATCH | INFO |  |  | Index presence comparison |
| policy_origin_grants.ix_policy_origin_grants_session_id | MATCH | INFO |  |  | Index presence comparison |
| run_ledger_events | MATCH | INFO |  |  | Table exists |
| run_ledger_events.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| sessions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| task_nodes.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| unified_task_approvals.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| unified_task_approvals.resolution_note | MATCH | INFO | text | text | Column type matches |
| unified_task_approvals.resolved_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| unified_task_snapshots.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| unified_task_timeline.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| unified_task_timeline.timestamp | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| unified_tasks.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| unified_tasks.restored_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| unified_tasks.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_admin_diagnostics.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_advanced_audit_records.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_advanced_audit_records.retention_until | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_api_keys.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_api_keys.last_used_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_api_keys.revoked_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_assistant_versions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_assistant_workspace_assignments.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_assistants.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_assistants.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_audit_events.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_billing_events.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_billing_plans.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_billing_settings.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_budget_alerts | MATCH | INFO |  |  | Table exists |
| v5_budget_alerts.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_budget_alerts.last_triggered_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_compliance_exports.completed_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_compliance_exports.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_compliance_exports.retention_until | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_entitlement_snapshots.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_governance_approval_workflows.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_governance_settings.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_integration_catalog.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_integration_connections.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_integration_connections.last_health_check_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_integration_connections.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_integration_health_events.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_invitations.accepted_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_invitations.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_invitations.email | MATCH | INFO | varchar | varchar | Column type matches |
| v5_invitations.expires_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_invoices.issued_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_invoices.paid_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_invoices.period_end | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_invoices.period_start | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_notifications.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_notifications.read_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_organization_members.joined_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_organization_settings.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_organizations | MATCH | INFO |  |  | Table exists |
| v5_organizations.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_organizations.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_organizations.ix_v5_organizations_slug | MATCH | INFO |  |  | Index presence comparison |
| v5_replay_shares | MATCH | INFO |  |  | Table exists |
| v5_replay_shares.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_replay_shares.created_by | MATCH | INFO | varchar | varchar | Column type matches |
| v5_replay_shares.expires_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_resource_versions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_retention_jobs.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_retention_jobs.scheduled_for | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_retention_rules.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_saved_tasks.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_saved_tasks.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_scim_configurations.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_scim_configurations.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_scim_sync_events.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_security_policies.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_security_policies.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_security_policy_versions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_sessions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_sessions.expires_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_sessions.id | MATCH | INFO | varchar | varchar | Column type matches |
| v5_sessions.last_seen_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_sso_configurations.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_sso_configurations.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_subscriptions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_subscriptions.current_period_end | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_subscriptions.current_period_start | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_subscriptions.trial_ends_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_subscriptions.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_team_activity.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_team_members.joined_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_teams.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_template_versions.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_templates.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_templates.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_usage_records.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_usage_rollups.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_user_preferences.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_user_preferences.preferences | MATCH | INFO | json | json | Column type matches |
| v5_user_preferences.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_user_profiles.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_user_profiles.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_user_profiles.user_id | MATCH | INFO | varchar | varchar | Column type matches |
| v5_users | MATCH | INFO |  |  | Table exists |
| v5_users.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_users.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_workflow_runs.completed_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| v5_workflow_runs.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_workflow_runs.started_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_workflow_runs.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_workflow_steps.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_workspace_members.joined_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_workspace_settings.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_workspace_shares.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_workspaces.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| v5_workspaces.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| validation_benchmark_runs.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| workflow_budgets.started_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| workflow_budgets.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| workflow_cost_metrics.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| workflow_events.approved_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
| workflow_events.confidence | MATCH | INFO | float | double precision | Column type matches |
| workflow_events.created_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| workflow_events.executed_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
...
| workflow_states.updated_at | MATCH | INFO | timestamp without time zone | timestamp without time zone | Column type matches |
